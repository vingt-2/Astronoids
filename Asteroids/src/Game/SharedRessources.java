 ...
 * 
 * 	<p>	Ressources are load in memory with their filepath, given a name and type.
 * 		The table is: <name / ressourceID> and can be accessed via the special functions for each type using the name. 
 *  </p>
